...
export default function Signup() {
  ...
  const backgroundText = "Signup with mail.";
  const title = "Great, lets create your account!";
                    ...
                    <div className="w-full">
                      <div className="">
                        <form onSubmit={onSubmit}>
                          ...
                          <input
                            className="dark:border-gray-400 dark:bg-gray-700 dark:hover:bg-gray-700 border rounded-md px-3 py-3 mt-1 mb-5 text-sm w-full"
                            id="username"
                            type="text"
                            label="Username"
                            variant="outlined"
